...
#   3. gh auth login
#   4. chmod +x create-emr-issues.sh
#   5. ./create-emr-issues.sh
#
...
validate_environment() {
  ...
  gh repo view "$REPO" >/dev/null 2>&1 || {
    ...
    echo "  REPO=seu-user/emr-despachante ./create-emr-issues.sh"
    exit 1
  }
...
- [ ] Analisar PRODUCT_DESCRIPTION.md, SCREEN_SPECS.md, DASHBOARD_SPEC.md e STATUS_MODEL.md
